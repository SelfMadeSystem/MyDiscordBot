...
export function interact(interaction: ButtonInteraction | SelectMenuInteraction) {
...
export const interactionIds = ['server_primary', 'server_secondary', 'server_tertiary'];

export const discordCommand = new SlashCommandBuilder().setName('test').setDescription('Test command.');